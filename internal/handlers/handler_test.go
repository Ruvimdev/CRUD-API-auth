...
// func (m *MockStorage) CreateUser(ctx context.Context, email, passwordHash string) (int, error){
// 	return 1, nil
// // 

// // ---- 2 тест ---- 
// func TestCreateUser_Succes(t *testing.T) {
// 	mockStorage := &MockStorage{}
// 	MockService := &MockService{}

// 	h := NewHandler(mockStorage, MockService)
